                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-top:0px;margin-bottom:0px">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li style="width: 63px;"><a href="https://nakiriayame.moe/resources/android.apk" download="android.apk" target="_blank" style="padding-left:18px"><img src="resources/Android.png" height="27"/></a></li>
